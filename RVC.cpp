...
// We will be using a 16-bit string length here -- our strings shouldn't be more than a word...but we give a lot of extra room to be safe
...
// Construct a file with the above functions given a CharacterClass object
