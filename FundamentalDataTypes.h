...
This header lays out all of the necessary functions for writing and reading VCS, RVO, RVC, RVR, and SKILLS files. It establishes our fundamental data types and functions for reading/writing those types to binary files.
